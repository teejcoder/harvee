...
### Rules
- **Scope changes → `.memory/overview.md`.** If a feature expands or contracts what the product does, update overview *first*, then implement.
